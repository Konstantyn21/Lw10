package com.example.constantin.lw10;
...
//                }
            ...
            canvas.drawText(" положение: " + Math.round(x) + ", " + Math.round(y) + "; нажато: " + counter++, mywidth-350, myheight-75, p3);// - выводит строку s в позиции x, y кистью p.
        }
    }
